...
account_value_df.to_excel('Account Values (Non-Overlapped delayed).xlsx')
#print(account_value_df)
# Plotting
import matplotlib.pyplot as plt

account_value_df.plot(figsize=(12, 6), title='Total Account Value Over Time (Non-Overlapped-Delayed)')
plt.xlabel("Date")
plt.ylabel("Account Value")
plt.grid(True)
plt.savefig('Total_Account_Value_Plot_Non-overlapped Delayed.png')
plt.show()